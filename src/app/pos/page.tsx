          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center">
                ...
                <h1 className="text-xl font-bold text-gray-900">Bella Vista Bistro POS</h1>
              </div>
            </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-600">+$234 from yesterday</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-600">$60.57</div>
              <p className="text-xs text-gray-600">+$3.42 from yesterday</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-orange-600">8/16</div>
